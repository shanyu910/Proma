...
import type { AuthStatus, LegisUser, LoginModalState } from '../types'
...
export const authUserAtom = atom<LegisUser | null>(null)
...
export async function clearStoredToken(): Promise<void> {
  try {
    ...
    console.error('[Legis Auth] 清除 Token 失败:', error)
  }
}
