...
import type { AgentStreamEvent, AgentStreamCompletePayload, AgentEvent, AgentStreamPayload, SDKAssistantMessage, SDKUserMessage, SDKSystemMessage, SDKContentBlock, SDKUserContentBlock, PromaEvent, AgentSessionMeta } from '@runwork/shared'
import { inferContextWindow } from '@runwork/shared'
      ...
      (streamEvent: AgentStreamEvent) => {
        ...
        for (const event of legacyEvents) {
          ...
          if (event.type === 'task_backgrounded') {
            ...
            store.set(agentPermissionModeMapAtom, (prev: Map<string, import('@runwork/shared').PromaPermissionMode>) => {
