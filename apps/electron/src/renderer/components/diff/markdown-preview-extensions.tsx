...
import { highlightCode, highlightToTokens, getDisplayName } from '@legis/core'
import { MermaidBlock } from '@legis/ui'
import type { HighlightTokensResult } from '@legis/core'
