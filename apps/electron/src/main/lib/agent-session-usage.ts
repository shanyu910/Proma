 ...
 *
 * 数据来源：~/.legis/agent-sessions/{id}.jsonl 里最后一条带 usage 的消息。
 * 优先级：
...
import { calculateContextUsageRatio, inferContextWindow } from '@legis/shared'
import type { SDKAssistantMessage, SDKResultMessage } from '@legis/shared'
