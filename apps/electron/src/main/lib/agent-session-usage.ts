 ...
 *
 * 数据来源：~/.runwork/agent-sessions/{id}.jsonl 里最后一条带 usage 的消息。
 * 优先级：
...
import { calculateContextUsageRatio, inferContextWindow } from '@runwork/shared'
import type { SDKAssistantMessage, SDKResultMessage } from '@runwork/shared'
